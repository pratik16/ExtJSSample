...
Ext.define('Regardz.view.bookingwizard.BookingWizardStep3Checkbox', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.bookingwizardstep3checkbox',
    loadMask: true,
    autoScroll: true,
    ...
    initComponent: function () {
        ...
        me.topPanel = {
            ...
            items: [{
                ...
                vertical: true,
                layout: 'hbox',
                items: [{ boxLabel: 'Gross prices'.l('SC53000'), name: 'price', inputValue: '1', checked: true, width: 125 },
    ...
    radioRender: function (value, metadata, record, rowIdx, colIndex, store) {
        ...
        ////onclick="setDefaultIds(' + rowIdx + ',\'' + bar + '\',\'' + store.storeId + '\')"
        return '<input id="rd_' + record.data.FixedPriceId + '_' + bar + '" ' + (record.data.Checked == true ? 'checked=checked' : '') + 'onclick="Utils.SelectedFixedPriceId=' + record.data.FixedPriceId + ';setDefaultIdsforOffer(' + rowIdx + ',\'' + bar + '\',\'' + store.storeId + '\')"" onchange="ValidateCheckbox(' + rowIdx + ',this);" ' + (record.data.Checked == true ? 'checked=checked' : '') + 'name="row_' + rowIdx + '" data-value="' + value + '" data-bar="' + barNum + '" type=checkbox> ' + formattedPrice + ''//myEl //
        //return '<input id="rd_' + record.data.FixedPriceId + '_' + bar + '" ' + (record.data.Checked == true ? 'checked=checked' : '') + ' onclick="Utils.SelectedFixedPriceId=' + record.data.FixedPriceId + ';setDefaultIds(' + rowIdx + ',\'' + bar + '\',\'' + store.storeId + '\')" >' + formattedPrice + ''//myEl //
    },
