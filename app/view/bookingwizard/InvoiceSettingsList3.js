Ext.define('Regardz.view.bookingwizard.InvoiceSettingsList3', {
    extend: 'Ext.grid.Panel',
    itemid: 'invoicesettingslist3',
    alias: 'widget.invoicesettingslist3',
    store: 'bookingwizard.BookingInvoiceSettings3Store',
    loadMask: true,
    ...
    initComponent: function () {
        ...
        me.viewConfig = {
            ...
            listeners: {
                beforedrop: function (node, data, dropRec, dropPosition, dropFunction, eOpt) {
                    var obj = Ext.ComponentQuery.query('[itemid="invoicesettingslist3"]')[0];
                ...
                drop: function (node, data, dropRec, dropPosition) {
                    var obj2 = Ext.ComponentQuery.query('[itemid="invoicesettingslist3"]')[0];
                    var store2 = obj2.getStore(); var index = -1;
                    //var dropOn = dropRec ? ' ' + dropPosition + ' ' + dropRec.get('name') : ' on empty view';
                    /////////////////////////////////////////////////////////////////////
                    var total = 0; var summaryRecord = null;
        ...
        me.height = 400,
        me.title = 'Items Invoice 3'.l('SC55100'),
        me.layout = "fit";
        me.noResize = true;
        me.columns =
        [
            { header: 'Description'.l('SC55100'), dataIndex: 'Name', flex: 1, renderer: this.colorRender },
            { header: 'Price'.l('SC55100'), dataIndex: 'TotalSum', width: 80, align: 'right', renderer: this.colorRender }
        ];
        me.bbar =
        [
            { xtype: 'tbfill' },
            'Total'.l('SC55100'),
            '|',
            { xtype: 'displayfield', itemid: 'total3', width: 80 }
        ];
