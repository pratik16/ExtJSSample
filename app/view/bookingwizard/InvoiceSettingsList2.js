Ext.define('Regardz.view.bookingwizard.InvoiceSettingsList2', {
    extend: 'Ext.grid.Panel',
    itemid: 'invoicesettingslist2',
    alias: 'widget.invoicesettingslist2',
    store: 'bookingwizard.BookingInvoiceSettings2Store',
    loadMask: true,
    ...
    initComponent: function () {
        ...
        me.viewConfig = {
            ...
            listeners: {
                ...
                drop: function (node, data, dropRec, dropPosition) {
                    ...
                    var obj2 = Ext.ComponentQuery.query('[itemid="invoicesettingslist2"]')[0];
        ...
        me.height = 400,
        me.title = 'Items Invoice 2'.l('SC55100'),
        me.layout = "fit";
        me.noResize = true;
        me.columns =
        [
        ...
        [
            ...
            'Total'.l('SC55100'),
            '|',
            { xtype: 'displayfield', itemid: 'total2', width: 80 }
        ];
